        ...
        <form class="layui-form " action="">
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="name" required  lay-verify="required" placeholder="请输入群名" autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
            ...
            $.ajax({
                ...
                success:function(res){
                    if (res.code == 200) {
                        ...
                        setTimeout(function () {
                            parent.location.href="/find?type=group&token="+$.cookie('token');
                        },1500);
                    }else{
                        layer.msg(res.msg,function(){});
                    }
